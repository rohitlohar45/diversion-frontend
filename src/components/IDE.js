				...
				<div className="h-screen flex flex-grow flex-col ">
					<div className="flex-grow flex ">
						<div id="editor" className="flex-grow relative flex flex-col ">
							...
							>
								<div className="shadow-lg border-2 border-opacity-50 border-primary-2 mx-2 rounded-xl">
									<Tabs
								...
								>
									<span className="hover:opacity-70 text-primary-1">... or upload an file</span>
								</div>
							</div>
						</div>
...
function RightVideoPanel({ muteCam, muteMic }) {
	...
	return (
		...
		>
			<div className="flex overflow-hidden custom-shadow-light h-full rounded-lg justify-start items-center flex-col bg-gradient-to-br from-primary-1 via-primary-3 to-primary-5 bg-opacity-100 relative pt-2 px-2 shadow-lg">
				...
				<div className="justify-between flex-col pt-2 pb-3">
					...
					<div className="flex items-center absolute backdrop-filter backdrop-blur left-0 bottom-0 pt-2 rounded-lg pb-4 w-full justify-around mt-2">
						<button
							...
							className={` ${
								isMuteMic ? "bg-primary-2 text-primary-5" : " bg-primary-5"
						...
						<button
							...
							className={`${
								isMuteCam ? "bg-primary-2 text-primary-5" : " bg-primary-5"
							} border transform duration-300 hover:shadow-2xl shadow-lg border-transparent rounded-full h-8 w-8 p-1.5`}
						>
...
function LanguageSelector({ language, setLanguage }) {
	return (
		<select
			className="text-primary-5 cursor-pointer bg-transparent"
			onChange={(e) => {
		...
		>
			<option className="bg-primary-3" value="cpp">
				cpp
			</option>
			<option className="bg-primary-3" value="python">
				python
			</option>
			<option className="bg-primary-3" value="java">
				java
			</option>
			<option className="bg-primary-3" value="javascript">
				javascript
			</option>
			<option className="bg-primary-3" value="perl">
				perl
			</option>
			<option className="bg-primary-3" value="php">
				php
			</option>
			<option className="bg-primary-3" value="ruby">
				ruby
			</option>
			<option className="bg-primary-3" value="pascal">
				pascal
			</option>
		</select>
	);
