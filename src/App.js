...
function Header({ runCode, toggleModal, isAuthenticated, isInputBoxShown, setisInputBoxShown }) {
	...
	return (
		<div className=" bg-primary-2 flex py-2 px-4 justify-between items-center rounded-b-lg custom-shadow-medium">
			<div className="flex items-center">
				<div className="h-7 flex items-center font-medium text-xl codeFont text-orange-standard">
					...
					<span className="ml-2 text-primary-5">&#123; ..SyncLink.. &#125;</span>
				</div>
			</div>
			<div className="flex items-center">
				<Tooltip label="Input/Output" hasArrow fontSize="md" bg="#FFF0F3" textColor="#590D22">
					<button className=" text-primary-5 mr-4" onClick={toggleInputBox}>
						<Icon icon="bi:input-cursor-text" className="text-orange-standard" height="24" />
					</button>
				</Tooltip>
				<Tooltip label="Whiteboard" hasArrow fontSize="md" bg="#FFF0F3" textColor="#590D22">
					<button className=" text-primary-5 mr-4" onClick={toggleModal}>
						<Icon icon={whiteboard24Regular} className="text-orange-standard" height="28" />
					</button>
				</Tooltip>
				<Tooltip label="Run Code" hasArrow fontSize="sm" bg="#FFF0F3" textColor="#590D22">
					<button
						onClick={runCode}
						className="bg-primary-5 flex items-center text-primary-1 font-medium rounded px-3 py-0.5 mr-2"
					>
